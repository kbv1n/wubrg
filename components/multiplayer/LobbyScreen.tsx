...
export function LobbyScreen({ gameState, localPlayerId, roomId, onLeave }: LobbyScreenProps) {
  ...
  // Generate shareable link — use roomId prop (set immediately on connect, not waiting for state)
  const shareLink = typeof window !== "undefined"
    ? `${window.location.origin}?room=${roomId || gameState.roomId}`
    : ""
